...
#define REAL_TIMER_TIME(cant)	((cant)/REAL_FREQ_SYSTICK_IS_CALLED)
...
/**
 * @brief configures the approximate value for the desired timer freq
 * ticks: the miliseconds you wish your timer to activate
 * return value needed to use in timerStart
 */
